...
const Banner = () => {
  return (
    <div className="flex items-center w-full flex-col w-screen">
      <section class="flex flex-col items-center w-full mt-32">
        <img
          ...
          height="128"
        />
        <h1 class="text-5xl font-bold mt-10 open-sans text-center">
          TasksBoard
        </h1>
        <h2 class="text-3xl mt-4 text-center">
          A desktop app for Google Tasks
        </h2>
        <a href="/app" class="mt-14">
          <div class="sign-in">
            <FcGoogle />
      ...
      <section class="max-w-6xl mt-16">
        <div class="flex flex-col-reverse sm:flex-row-reverse mt-10 sm:mt-4 items-center w-full px-4 md:px-8 lg:px-28 mb-24">
          <img
            class="w-full md:w-1/2 p-4 object-scale-down"
            alt="Manage your Google Tasks"
            src="https://i.ibb.co/9gVN84d/google-tasks-full-screen.jpg"
          />
          <div class="w-full md:w-1/2 p-10">
            <h1 class="text-3xl font-bold mb-4 leading-10">
              Get more things done on a full screen
            </h1>
            <h2 class="mb-6 text-xl text-gray-600 leading-8">
              Organize your lists in full screen board to stay on top of your
              work.
            </h2>
            <a class="text-blue-600 open-sans hover:text-blue-700" href="/app">
              Get Started
            </a>
          </div>
        </div>
        <div class="flex flex-col-reverse sm:flex-row mt-10 sm:mt-4 items-center w-full px-4 md:px-8 lg:px-28 mb-24">
          <img
            class="w-full md:w-1/2 p-8 object-scale-down"
            alt="Share your Google Tasks list with anyone"
            src="https://i.ibb.co/vvz1y3T/share-google-tasks.jpg"
          />
          <div class="w-full md:w-1/2 p-10">
            <h1 class="text-3xl font-bold mb-4 leading-10">Share your tasks</h1>
            <h2 class="mb-6 text-xl text-gray-600 leading-8">
              Share your Google Tasks lists in real-time with your team with one
              link.
            </h2>
            <a
              class="font-medium text-blue-600 open-sans hover:text-blue-700"
              href="/app"
            >
              Get Started
            </a>
        ...
        <div class="flex flex-col-reverse sm:flex-row mt-10 sm:mt-4 items-center w-full px-4 md:px-8 lg:px-28 mb-24">
          <div class="w-full md:w-1/2 flex flex-row items-center justify-between p-8">
            <a href="/app" target="_blank" rel="noreferrer">
              <div class="flex flex-col items-center">
                <img
                  class="bounce cursor-pointer"
                  alt="TasksBoard is synced with Google Tasks on iOS"
                  src="https://i.ibb.co/yVK31Ld/iosLogo.jpg"
                  width="84"
                  height="150"
                />
                <label class="mt-4 text-gray-600">iOS</label>
              </div>
            </a>
            <a href="/app" target="_blank" rel="noreferrer">
              <div class="flex flex-col items-center">
                <img
                  ...
                  height="150"
                />
                <label class="mt-4 text-gray-600">Android</label>
              </div>
            </a>
            <a href="/app" rel="noreferrer" target="_blank">
              <div class="flex flex-col items-center">
                <img
                  ...
                  height="150"
                />
                <label class="mt-4 text-gray-600">Calendar</label>
              </div>
            </a>
          </div>
          <div class="w-full md:w-1/2 p-10">
